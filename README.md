...
No coding required.
Step 1 — Download
Go to the Releases page and download traktor-visuals.exe
Step 2 — Set up Traktor Broadcasting
This tells Traktor to send track info to the app.

Open Traktor
Go to Preferences (cog icon, top right)
Click Broadcasting in the left sidebar
Fill in these exact values:

FieldValueAddress127.0.0.1Port8000Mount path/Passwordtraktor123FormatOgg Vorbis, 44100 Hz

Click Apply and close Preferences
...
In the left menu go to APIs & Services → Enable APIs & Services
Search for YouTube Data API v3 → click it → click Enable
Go to APIs & Services → Credentials → + Create Credentials → API Key
Copy the key that appears — you'll paste it into the app in the next step

Step 4 — Run

Double-click traktor-visuals.exe
A terminal window opens and asks for your YouTube API key — paste it in and press Enter
Your key is saved — it won't ask again next time
Open http://localhost:3000 in your browser
In Traktor, open the Audio Recorder panel (the cassette/tape icon in the top bar)
Click the antenna icon — it should turn solid and stay on
Load a track in Traktor and hit Play
...
ModeEffectBarsSpring-physics equaliser bars, grow symmetrically from centreWaveUndulating sine wave that breathes and shifts over timeStaticChunky coloured noise, like VHS interferenceSparklesParticles shoot outward from the split line into both videosRingsExpanding concentric circles at random heightsHelixTwo interweaving DNA-strand sine waves in pink and blue
